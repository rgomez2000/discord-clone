...
export const ChatItem = ({
    ...
    // Worry about this later, fixing file type detection 
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isImage && (
                        <a
                            ...
                            flex items-center bg-secondary h-96 w-96"
                        >
                            <Image 
                                src={fileUrl}
                                alt={content}
                    ...
                    {/* THIS IS BROKEN AND NEEDS TO BE FIXED, NAMING FOR FILES CHANGED */}
                    {isPDF && (
